...
{
    fprintf(stderr, "\nUsage: %s [t ON/OFF] [-s SENS] [-l LED] [-v WHEN] [-i IR] [-r ROTATE] [-a AIHUMANDETECTION] [-m MOVE] [-p NUM] [-P] [-f FILE] [-S] [-T] [-d]\n\n", progname);
...
//    int babycrying = NONE;
    ...
    while (1) {
        ...
        c = getopt_long (argc, argv, "t:s:l:v:i:r:a:b:n:m:p:Pf:S:Txdh",
