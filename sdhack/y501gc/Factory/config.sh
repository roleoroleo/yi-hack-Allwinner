...
if test -f /tmp/sd/home_y501gcm.stage; then
    echo "/tmp/sd/home_y501gcm.stage exist, renaming for firmware update"
    mv /tmp/sd/home_y501gcm.stage /tmp/sd/home_y501gcm
fi
